                    ...
                    <Hei1000 style={{ height: "1000px" }}>
                        <Row>
                            <Col>
                                ...
                                {type === 1 ?
                                    <div>
                                        <Button className="programUserbutton" color="primary" onClick={(e) => onProgramSubmitToggle(e)}>프로그램 추가</Button>
                                        <Nav tabs>
                                    ...
                                    : type === 2 ?
                                        <div>
                                            <Button className="programUserbutton" color="primary" onClick={(e) => onUserSubmitToggle(e)}>User 추가</Button>
                                            <Nav tabs>
                                                <Dropdown isOpen={dropdownOpen} toggle={toggleDrop}>
