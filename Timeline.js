...
const Message = () => {
  ...
  let onDetailSubmit = async (e) => {
    ...
    await axios.post('API', JSON.stringify(detailData)).then((res) => {
            ...
            <Row >
              <Col lg="12">
                <Nav tabs>
                  ...
                  {/*타임라인 추가 modal*/}
                  {imodal === true ? <Modal isOpen={imodal}>
                    <ModalHeader style={{fontFamily: "Jua", fontSize: "30px", paddingLeft: '34%'}}>타임라인 메세지 추가</ModalHeader>
                  ...
                  {emodal === true ? <Modal isOpen={emodal}>
                    <ModalHeader style={{ fontFamily: "Jua" }}>타임라인 수정</ModalHeader>
                    <ModalBody>
                      <Box>
                        <p className="attr">제목</p>
                  ...
                  {dmodal === true ? <Modal isOpen={dmodal}>
                    ...
                    <ModalBody>
                      ...
                      <div className="deletesurveyBtn">
                        <Button className="tsubmit" color="secondary" onClick={(e) => xModal()} >취소</Button>
                        <Button className="tsubmit" color="primary" onClick={(e) => deleteTimeline(e)}>삭제</Button>
                      </div>
                    </ModalBody>
                  </Modal> : <Modal isOpen={false}></Modal>}

                  {dDmodal === true ? <Modal isOpen={dDmodal}>
                    <ModalHeader ><span className="dmodalheader">디테일 삭제</span></ModalHeader>
                    <ModalBody>
                      <p className="dmodalbody">해당 디테일을 정말 삭제하시겠습니까?</p>
                      <div className="deletesurveyBtn">
                        <Button className="tsubmit" color="secondary" onClick={(e) => xModal()} >취소</Button>
                        <Button className="tsubmit" color="primary" onClick={(e) => deleteDetail(e)}>삭제</Button>
                      </div>
                    </ModalBody>
                  </Modal> : <Modal isOpen={false}></Modal>}
                              ...
                              </div>
                              {
                                (data.TYPE === "1" || data.TYPE === 1 || data.TYPE === '2' || data.TYPE === 2 || data.TYPE === '4' || data.TYPE === 4 || data.TYPE === '5' || data.TYPE === 5)
                                  ...
                                  <InputGroup>
                                    ...
                                    <img id="img" src={"http://walkon-prd.s3.amazonaws.com/v2/no_image/no_img.jpg"} width="200" height="200" ></img></InputGroup> :
                                  ...
                                  listtype['list_type' + i] === "1" || listtype['list_type' + i] === 1 || (data.TYPE === 1 && listtype['list_type' + i] === undefined) ?
                                    ...
                                    listtype['list_type' + i] === '2' || listtype['list_type' + i] === 2 || (data.TYPE === 2 && listtype['list_type' + i] === undefined) ?
                                      ...
                                      : listtype['list_type' + i] === '3' || listtype['list_type' + i] === 3 || (data.TYPE === 3 && listtype['list_type' + i] === undefined) ?
                                        <InputGroup>
                                          <Input type="file" name={"img" + `${i}`} onChange={(e) => getImage(e, i)}></Input>
                                          <div><img id="img" src={data.IMG === undefined ? "http://walkon-prd.s3.amazonaws.com/v2/no_image/no_img.jpg" : "http://walkon-prd.s3.amazonaws.com" + data.IMG} width="200" height="200" ></img></div>
                                        </InputGroup>
                                                ...
                                                <Card>
                                                  <CardBody>
                                                    {surveyQuestion.map((qdata, k) => {
                                                      return (
                                                        <div key={k} className="getquestion">
                            ...
                            {check === false ? "" :
                              <div className="paging">
                                ...
                                {paramWeek === '0' || paramWeek === 0 ? "" : numberArr.map((data, i) => {
                                  ...
                                  return (
                                    <button key={i} className="pagingnum" key={i} onClick={(e) => getDaystate(data)}>{data}</button>
                                  )
                                })}
                                  ...
                                  {dayState.map((data, i) => {
                                    ...
                                    return (
                                      <div className="timelinebox" key={i}>
                                        ...
                                        <Button className="delbt" onClick={(e) => toggledeleteTimeline(data, e)}>삭제</Button>
                                        <Button color="info" className="edbt" onClick={(e) => toggleeditTimeline(data, e)}>수정</Button>
                                      </div>
                                    )
                                  })}
                                </div></div>}
                                        ...
                                        return (
                                          <div key={i}>
                                            ...
                                            {data.TYPE === 1 ? <div><div className="type">TITLE </div><p className="detailtxt">{data.TITLE}</p></div> : data.TYPE === 2 ? <div><div className="type">TXT </div><p className="detailtxt">{data.TXT}</p></div> : data.TYPE === 3 ? <div><div className="type">IMG </div><img className="detailimg"
                                              id="img1"
                                              src={"http://walkon-prd.s3.amazonaws.com" + data.IMG}
                                              width="200"
                                              height="200"
                ...
                {daymodal === true ? <Modal isOpen={daymodal}>
                  <ModalHeader style={{ fontFamily: "Jua", fontSize: "30px", textAlign: "center" }} >Day Group 수정</ModalHeader>
                  <ModalBody>
                    <Box>
                      <p className="attr" style={{ fontFamily: "Jua", fontSize: "20px", textAlign: "center" }}>타이틀</p>
                ...
                {iwmodal === true ? <Modal isOpen={iwmodal}>
                  <ModalHeader style={{fontFamily: "Jua", fontSize: "30px", paddingLeft: '42%'}}>Week 추가</ModalHeader>
                  <ModalBody>
                    <Box>
                      <p className="attr">프로그램 타입</p>
                ...
                {<Modal isOpen={addDetailModal}  >
                  ...
                  <ModalBody>
                              ...
                              listtype['list_type' + i] === '2' || listtype['list_type' + i] === 2 ?
                                ...
                                : listtype['list_type' + i] === '3' || listtype['list_type' + i] === 3 ?
                                  <InputGroup>
                                    ...
                                    <div>
                                      <img id="img" src="http://walkon-prd.s3.amazonaws.com/v2/no_image/no_img.jpg" width="200" height="200" ></img>
                    ...
                    <Button type="submit" className="tsubmit" onClick={(e) => xModal()} color="secondary">취소</Button>
                    <Button type="submit" className="tsubmit" color="primary" onClick={(e) => onDetailSubmit()} >추가</Button>
