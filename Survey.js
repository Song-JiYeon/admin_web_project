...
const Survey = () => {
  ...
  const [surveySelect, setsurveySelect] = useState([]); //설문지 저장
  const [surveyQuestion, setsurveyQuestion] = useState([]); //질문지 저장
  const [questiondata, setQuestiondata] = useState('0'); //question_id 저장
  ...
  const [arr, setArr] = useState([0,]); //객관식, 단답식 question_choice 창
  const [typenum, setTypenum] = useState([]);
  const [tmp, setTmp] = useState([]);

  const [modal, setModal] = useState(false); //질문 수정 modal
  const [smodal, setSmodal] = useState(false); //설문 추가 modal
  const [qmodal, setQmodal] = useState(false); //질문 추가 modal
  const [sDmodal, setSDmodal] = useState(false); //설문 삭제 modal
  const [qDmodal, setQdmodal] = useState(false); //질문 삭제 modal
  ...
  /*객관식 및 단답식 question_choice 저장하는 함수*/
                    ...
                    return (
                      <TabContent activeTab={activeTab} key={i}>
                        <TabPane tabId={(i + 1).toString()}>
                          ...
                          {/*질문지 추가 버튼, 설문지 삭제 버튼 deleteSurvey(datafirst, e)*/}
                              ...
                              <Card className="cardbody" body outline color="link">
                                ...
                                {surveyQuestion.map((data, i) => (
                                  <div className="questionlist" tag="h6" color="info" key={i}>
                                    ...
                                    <button style={{fontFamily: 'Jua'}} className="deleteqBtn" onClick={(e) => questionDeleteToggle(data, e)} >삭제</button>
                                    <button style={{fontFamily: 'Jua'}} className="modifyqBtn" onClick={(e) => modifyToggle(data, e)} >수정</button>
                                  </div>
                                ))}
                                {/*</Fade>*/}
                                ...
                                {qmodal === true ? <Modal isOpen={qmodal}  >
                                  ...
                                  <ModalBody>
                                    ...
                                    <div className="qsubmit">
                                      <Button style={{fontFamily: 'Jua'}} className="submitBt" onClick={(e) => xModal()}>취소</Button>
                                ...
                                {sDmodal === true ? <Modal isOpen={sDmodal}  >
                                  ...
                                  <ModalBody>
                                    ...
                                    <div className="deletesurveyBtn">
                                      <Button style={{fontFamily: 'Jua'}} color="primary" onClick={(e) => deleteSurvey(e)}>삭제</Button>{' '}
                                ...
                                {qDmodal === true ? <Modal isOpen={qDmodal}>
                                  ...
                                  <ModalBody>
                                    ...
                                    <div className="deletesurveyBtn">
                                      <Button style={{fontFamily: 'Jua', marginRight: "2px"}} color="primary" onClick={(e) => questionDelete(e)}>삭제</Button>
                                      <Button style={{fontFamily: 'Jua'}} color="secondary" onClick={(e) => xModal()} >취소</Button>
                                    </div>
                                  </ModalBody>
                                </Modal> : <Modal isOpen={false}></Modal>}
